...
// importamos la funcion para incrementar los alumnos
const { incrementarAlumnos, cursos } = require("./adminController");
    ...
    fs.readFile(req.file.path, "utf8", (err, data) => {
        ...
        try {
            ...
            jsonData.forEach((actividad) => {
                ...
                const existe = actividades.some((a) => a.nombre === actividad.nombre && a.profesor === actividad.profesor);
                ...
                if (!existe) {
                    ...
                    const actividadIndex = actividades.findIndex(
                        (a) => a.nombre === actividad.nombre && a.profesor === actividad.profesor
                    );
...
exports.obteneractividades = (req, res) => {
    ...
    const actividadesProfesor = actividades.filter((actividad) => actividad.profesor === codigo); 
...
exports.cargarAlumnons = (req, res) => {};
